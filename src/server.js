            ...
            .then((response) => {
              ...
              data.map((e,i) => {
                ...
                if (isMinorRes && isMinorRes == "true") {
                  ...
                  console.log(`https://api.opiniion.com/_services/opiniion/customer?uid=${bidRes}&api=${apikeyRes}&firstname=${e.FirstName}&lastname=${e.LastName}&email=${e.Email}&countrycode=+1&phone=${mobile}&q=1`);
                    axios.post(`https://api.opiniion.com/_services/opiniion/customer?uid=${bidRes}&api=${apikeyRes}&firstname=${e.FirstName}&lastname=${e.LastName}&email=${e.Email}&countrycode=+1&phone=${mobile}&q=1`).then(response => {
                      console.log('first', response);
                    }, error => {
                      console.log('first', error.code, error.config);
                    })
                } else if(0 >= 0 < evaluateDate(d1,d2) && evaluateDate(d1,d3) >= -7){
                  console.log(`https://api.opiniion.com/_services/opiniion/customer?uid=${bidRes}&api=${apikeyRes}&firstname=${e.FirstName}&lastname=${e.LastName}&email=${e.Email}&countrycode=+1&phone=${mobile}&q=2`);
                  axios.post(`https://api.opiniion.com/_services/opiniion/customer?uid=${bidRes}&api=${apikeyRes}&firstname=${e.FirstName}&lastname=${e.LastName}&email=${e.Email}&countrycode=+1&phone=${mobile}&q=2`).then(response => {
                      console.log('second', response);
                    }, error => {
                      console.log('sendon', error.code, error.config);
                    })
                } else {
                  console.log(`https://api.opiniion.com/_services/opiniion/customer?uid=${bidRes}&api=${apikeyRes}&firstname=${e.FirstName}&lastname=${e.LastName}&email=${e.Email}&countrycode=+1&phone=${mobile}`);
                  axios.post(`https://api.opiniion.com/_services/opiniion/customer?uid=${bidRes}&api=${apikeyRes}&firstname=${e.FirstName}&lastname=${e.LastName}&email=${e.Email}&countrycode=+1&phone=${mobile}`).then(response => {
